...
class PlayerListFragment : Fragment(){
    ...
    private val playersViewModel: PlayersViewModel by lazy {
        activity?.let {
            ViewModelProvider(it, ViewModelProvider.AndroidViewModelFactory(it.application)).get(PlayersViewModel::class.java)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        rv_players.layoutManager = LinearLayoutManager(this.context)
        subscribeUi(adapter)
    }
